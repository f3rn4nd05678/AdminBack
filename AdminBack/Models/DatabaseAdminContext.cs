...
public partial class DatabaseAdminContext : DbContext
{
    public DatabaseAdminContext()
    {
    }

    public DatabaseAdminContext(DbContextOptions<DatabaseAdminContext> options)
        : base(options)
    {
    }
